...
class CodegenLoader extends AssetLoader{
  ...
  "enter_new_pin": "Придумайте пін-код ",
  "re_enter_pin": "Підтвердіть пін-код",
  "use_biometrics": "Бажаєте надалі використовувати відбиток пальця або FaceId для входу?",
  "yes": "Так",
  "no": "Ні",
  "first_name": "Імʼя",
  "last_name": "Прізвище",
  ...
  "stats": "Статистика",
  "home": "Головна",
  "empty_search": "Жодної транзакції не знайдено",
  ...
  "overview": "ОГЛЯД",
  "details": "ДЕТАЛІ",
  "select": "Виберіть тип транзакції",
  "delete": "Видалити",
  "add_income": "Додати до доходів",
  "add_expense": "Додати до витрат",
  "add_smth": "Додати нову транзакцію",
  "empty_list": "Тут ще нічого немає.\nБудь ласка, додайте транзакцію.",
  "months": {
    "jan": "Січень",
    "feb": "Лютий",
    "mar": "Березень",
  ...
  "choose_icon": "ОБЕРІТЬ ІКОНКУ КАТЕГОРІЇ",
  "q_delete_acc": "Ви бажаєте видалити аккаунт або закрити додаток Kitty?",
  "q_sure_delete_acc": "Ви впевнені що бажаєте видалити аккаунт?",
  "delete_acc": "Видалити аккаунт",
  "close_app": "Закрити додаток",
  "sign_in": "Натисніть для авторизації",
  "q_use_bio": "Бажаєте надалі використовувати відбиток пальця або FaceId для входу?",
...
static const Map<String,dynamic> en = {
  ...
  "use_biometrics": "Would you like to use biometrics to authentication on future visits",
  "yes": "Yes",
  "no": "No",
  ...
  "stats": "Statistics",
  "home": "Home",
  "empty_search": "Any transaction not found",
  "settings": "Settings",
  ...
  "overview": "OVERVIEW",
  "details": "DETAILS",
  "select": "Select the type of transaction",
  "delete": "Delete",
  ...
  "choose_icon": "CHOOSE CATEGORY ICON",
  "q_delete_acc": "Do you want to delete your account or close the Kitty app?",
  "q_sure_delete_acc": "Are you sure you want to delete this account?",
  "delete_acc": "Delete acc",
  "close_app": "Close app",
  "sign_in": "Press to sign in",
  "q_use_bio": "Бажаєте надалі використовувати відбиток пальця або FaceId для входу?",
  "added_category": "New category added successfully!",
  "empty_list": "Here's nothing yet.\nPlease add a transaction.",
  "faq_data": {
    "questions": {
