...
class __$$_ExpenseCategoryCopyWithImpl<$Res>
    extends _$ExpenseCategoryModelCopyWithImpl<$Res, _$_ExpenseCategory>
...
class _$_ExpenseCategory implements _ExpenseCategory {
  ...
  @override
  String toString() {
    return 'ExpenseCategoryModel(title: $title, totalAmount: $totalAmount, entries: $entries, icon: $icon)';
  }
...
abstract class _ExpenseCategory implements ExpenseCategoryModel {
  const factory _ExpenseCategory(
      {required final String title,
      final double totalAmount,
      final int entries,
      required final IconModel icon}) = _$_ExpenseCategory;
