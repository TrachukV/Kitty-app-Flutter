  ...
  showGeneralDialog(
    ...
    pageBuilder: (BuildContext buildContext, Animation<double> animation,
      ...
      return MultiBlocProvider(
        providers: [
          BlocProvider.value(
            value: BlocProvider.of<StatisticsDateBloc>(context),
          ),
          BlocProvider.value(
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: BlocConsumer<StatisticsDateBloc, StatisticsDateState>(
          listener: (context, state) {},
          builder: (context, state) {
            final selectedDate =
                context.watch<StatisticsBloc>().state.selectedDateStatistics;
                      ...
                      children: List.generate(12, (index) {
                        return MonthItem(
                            ...
                            onTap: () {
                              context
                                  .read<StatisticsBloc>()
                                  .add(StatisticsEventLog(
                                    DateTime(
                                      state.dateTime.year,
                                      index + 1,
                                    ),
                                  ));
                              context.read<StatisticsDateBloc>().add(ChooseDate(
                                    DateTime(
                                      state.dateTime.year,
                                      index + 1,
                                    ),
